...
RSpec.describe SponsoredpostsController, type: :controller do
  ...
  describe "GET show" do
    ...
    it "assigns my_sponsoredpost to @sponsoredpost" do
      get :show, topic_id: my_topic.id, id: my_spondored_post.id
  ...
  describe "POST create" do
    it "increases the number of Post by 1" do
      expect{sponsoredpost :create, topic_id: my_topic.id, post: {name: RandomData.random_sentence, body: RandomData.random_paragraph}}.to change(SponsoredPost,:count).by(1)
    end
    it "assigns Sponsored_Post.last to @sponsored_post" do
      sponsoredpost :create, topic_id: my_topic.id, sponsored_post: {name: RandomData.random_sentence, body: RandomData.random_paragraph}
  ...
  describe "PUT update" do
    it "updates post with expected attributes" do
      ...
      put :update, topic_id, id: my_sponsored_post.id, sponsored_post: {title: new_title, body: new_body, price: new_price }
  ...
  describe "DELETE destroy" do
    it "delets the post" do
      delete :destroy, topic_id: my_topic_id, id: my_sponsored_post.id
