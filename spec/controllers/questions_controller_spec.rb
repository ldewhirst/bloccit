...
RSpec.describe QuestionsController, type: => :controller do
  let (:my_question) { Question.create!(title: Random.Data_random_sentence, body: RandomData.random_paragraph, resolved: resolved) }
  ...
  describe "POST create" do
    it "increases the number of Question by 1" do
      expect {question :create, question: {title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved: resolved}}.to change(Question,:count).by(1)
    end
  ...
  describe "GET update" do
    it "updates question with expected attributes" do
      ...
      put :update, id: my_question.id, question:{title: new_title, body: new_body, resolved: resolved}
  ...
  describe "GET edit" do
    ...
    it "assigns question to be updated to @question" do
      ...
      expect(post_instance.title).to eq my_quesiton.title
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to questions index"d do
      delete :destroy, {id: my_question.id}
